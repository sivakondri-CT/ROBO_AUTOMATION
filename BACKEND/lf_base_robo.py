                ...
                if battery <= self.min_battery:
                    ...
                    if self.nav_data_path:
                        with open(self.nav_data_path, 'r') as x:
                            ...
                            navdata['Canbee_location'] = self.charge_point_name
                            navdata['Canbee_angle'] = ''
                            navdata['prev']=navdata['current']
                            navdata['current']=self.charge_point_name
                    ...
                    print("[OK] Battery at {}%. Continuing test.".format(battery))
                    return pause, stopped
